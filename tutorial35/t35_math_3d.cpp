...
namespace t35
{
  ...
  void Matrix4f::InitPerspProjTransform(const PerspProjInfo& perspProjInfo)
  {
    ...
    const float _m00 = 1.0f / (tanHalfFOV * ar);
    const float _m11 = 1.0f / tanHalfFOV;
    const float _m22 = (-perspProjInfo.zNear - perspProjInfo.zFar) / zRange;
    const float _m23 = 2.0f * perspProjInfo.zFar * perspProjInfo.zNear / zRange;

    m[0][0] = _m00;  m[0][1] = 0.0f;  m[0][2] = 0.0f;  m[0][3] = 0.0f;
    m[1][0] = 0.0f;  m[1][1] = _m11;  m[1][2] = 0.0f;  m[1][3] = 0.0f;
    m[2][0] = 0.0f;  m[2][1] = 0.0f;  m[2][2] = _m22;  m[2][3] = _m23;
