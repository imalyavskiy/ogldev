...
static void RenderSceneCB()
{
	...
	// Каноническая матрица поворота    
	// в плоскости XOY меет вид:       | в плоскости XOZ меет вид:       | в плоскости YOZ меет вид:       |
	...
	// Задаём матирцу поворота XOY в транспонированном виде, возможно сделано так для удобства записи кода
    World.m[0][0] = cosf(Scale); World.m[0][1] = -sinf(Scale); World.m[0][2] = 0.0f; World.m[0][3] = 0.0f;   //  cos(a) -sin(a)    0       0
	World.m[1][0] = sinf(Scale); World.m[1][1] = cosf(Scale);  World.m[1][2] = 0.0f; World.m[1][3] = 0.0f;	 //  sin(a)  cos(a)    0       0
