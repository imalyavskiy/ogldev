...
namespace t21
{
  ...
  Camera::Camera(const int winWidth, const int winHeight)
  {
  ...
  Camera::Camera(const int winWidth, const int winHeight, const Vector3f& pos, const Vector3f& target, const Vector3f& up)
  {
    m_windowWidth  = winWidth;
    m_windowHeight = winHeight;
    m_pos = pos;
  ...
  bool Camera::OnKeyboard(const int key)
  {
    switch (key) {
      case GLUT_KEY_UP:
        {
