...
// Идентификатор связываемый с uniform переменной gScale вершинного шейдера
...
// Переменная доступная из вне шейдерного программного объекта 
...
static void RenderSceneCB()
{
	...
	// Аргумент функции(sin) расчёта коэффициента масштабирования
    static float Scale = 0.0f;

	// Приращение
    Scale += 0.005f;

	// Установка вычисленного коэффициента масштабирования в переменную gScale вершинного 
	// шейдера через её идентификатор хранящийся в gScaleLocation
	...
	// Подключаем буфер, как буфер массивов(к bind target - GL_ARRAY_BUFFER)
...
static void CreateVertexBuffer()
{
	...
	// Запрашиваем у OpenGL создание буферного объекта(объекта состоящего из буферов)
...
static void CompileShaders()
{
	...
	// Получаем OpenGL ID uniform переменной gScale вершинного шейдера
