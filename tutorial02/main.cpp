...
static void RenderSceneCB()
{
    ...
    glDrawArrays( GL_POINTS	// Тип отрисовки - отдельные точки.
				, 0			// Индекс первого элемента буфера вершин.
				, 1			// Количество элементов для отрисовки.
				);
...
{
	// Массив из одной вершины
    Vector3f Vertices[1];
	
	// Задание координат вершины
	...
	// Копируем данные из массива вершин в буфер вершин OpenGL
